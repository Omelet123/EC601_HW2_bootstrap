...
class BasicTest(unittest.TestCase):
    def setUp(self):
        ...
        self.username = "gyt@bu.edu"
        self.authkey = "udd41f39c2623f7b"
    ...
    def test_CBT(self):
        ...
        try:
            # load the page url
            print('Loading Url')
            self.driver.get('https://resume-cc060.firebaseapp.com/')
            ...
            self.assertEqual("Yutong Gao's Resume", self.driver.title)
